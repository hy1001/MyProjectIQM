...
if isempty(POPvalues0),
    if ~INIT_RUN_ALREADY,
        ...
        IQMbuildPopPKModelSpace('MODEL_00_INITIAL_GUESSES', modeltest, dataNLMEpath, dataheaderNLME, options, optionsModelSpace);
...
oldpath = pwd();
cd([outputPath '/Data']);
IQMbuildPopPKModelSpace(nameSpace, modeltest, dataNLMEpath, dataheaderNLME, options, optionsModelSpace);
cd(oldpath);

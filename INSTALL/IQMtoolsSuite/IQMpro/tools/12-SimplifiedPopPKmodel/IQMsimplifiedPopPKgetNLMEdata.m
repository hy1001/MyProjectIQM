...
% Do the cleaning
dataCleaned         = IQMcleanPopPKdataWrapper(dataTaskPath,nameDose,namePK,covNames,catNames,removeSUBJECT,removeRECORD,pathCleaningResults,catImputationValues);

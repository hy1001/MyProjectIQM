...
dosing                      = IQMcreateDOSING({'BOLUS','INFUSION','ABSORPTION0'},{DOSING_DOSE_ABS DOSING_DOSE_IV DOSING_DOSE_ABS},{DOSING_TIME_ABS DOSING_TIME_IV DOSING_TIME_ABS},{[] DOSING_TINF_IV 1e-10},{0 0 0});

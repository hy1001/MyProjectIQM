...
%  Zero-order, first-order, and mixed absorption models
...
%    -------------------------
%       modeltest.absorptionModel           Vector with elements: 1 (first order) 0 (zero order) and/or 2 (mixed first and 
%                                           zero order (parallel) absorption). This is an optional definition, since 

function [dataOut] = IQMconvertGeneral2TaskDataset(data,DOSENAMES,OBSNAMES,covariateInfoTimeIndependent,covariateInfoTimeDependent)
...
% Add NLME info
dataOut = IQMaddNLMEinfo2data(dataOut,DOSENAMES);

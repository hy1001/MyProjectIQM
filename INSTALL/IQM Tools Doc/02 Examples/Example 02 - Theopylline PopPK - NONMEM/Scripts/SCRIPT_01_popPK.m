%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% IQM Tools - Theophylline PopPK Example (NONMEM Version)
%
% SCRIPT_01_popPK
% ---------------
...
%
% In comparison to the MONOLIX version of this example it becomes very 
% clear how huge the numerical issues in NONMEM are. This unfortunately 
% translates to results that render decision making for the next modeling
% step very difficult. Often leading to loops of iterations.
%
...
% General settings
optionsNLME.parameterEstimationTool         = 'NONMEM';         % Default parameter estimation tool 
...
optionsNLME.algorithm.NRCHAINS              = 5;                % Set number of chains (for SAEM in both NONMEM and MONOLIX)
...
% - Best 2 fits (by OFV/BIC) crashed and cant be taken seriously
% - Very high RSEs on Q1 and Vp1, confirming what was seen in the data
%   exploration - most likely one compartment model enough
% - Lag time seems to be identifiable 
% - Additive part of error model seems not to be identifiable ...
% 
...
modeltest.FACTOR_UNITS              = 1;
%                                       CL    Vc    Q1    Vp1    Q2    Vp2    Fiv    Fabs1    ka    TlagAbs1   Fabs0   Tk0   TlagAbs0   Frel0   VMAX   KM
modeltest.POPvalues0                = [ 3.43  42    10    500    10    500    1      1        2.41  0.147      1       1     0.5        0.5     1e-10   10];
modeltest.POPestimate               = [ 1     1     1     1      1     1      0      0        1     1          0       1     1          1       0       0];
modeltest.IIVestimate               = [ 1     1     1     1      1     1      0      0        1     1          0       1     1          1       0       0];
modeltest.IIVvalues0                = [ 0.5   0.5   0.5   0.5    0.5   0.5    0.5    0.5      0.5   0.5        0.5     0.5   0.5        0.5     0.5     0.5];
...
%% Results of previous analyis
% - Very robust results for 1st order absorption
% - 4 out of 4 models with zero order absorption "crashed", 1 out of 4 models 
%   for 1st order and mixed order absorption crashed
% - 1st order absorption best from BIC of non-crashed models
% - Best uncrashed model: FITMODEL_02_BASEMODEL_ABSORPTION_005
% - Good convergence trajectories
% - High correlation CL and Vc ... might be reason for high RSE on CL
% Decision: FITMODEL_02_BASEMODEL_ABSORPTION_005 is final base model

%% Selection of final BASE model and duplicate it to output
modelSource         = '../Models/MODEL_02_BASEMODEL_ABSORPTION/FITMODEL_02_BASEMODEL_ABSORPTION_005';
...
%% Results of previous analyis
% - Model without covariates best
% - So significant covariate ... no surprise.
...
%% Results of previous analyis
% - Best model with correlation of CL and Vc only.

%% Selection of FINAL model and duplicate it to output
modelSource         = '../Models/MODEL_04_COVARIANCE/FITMODEL_04_COVARIANCE_002';
